...
class _$_Initial implements _Initial {
  ...
  @override
  String toString() {
    return 'LoginState.initial(email: $email, password: $password, status: $status, errorMessage: $errorMessage)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return initial(email, password, status, errorMessage);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return initial?.call(email, password, status, errorMessage);
  }
